      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">hello@tinabakery.com</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-sm text-muted-foreground">Mon-Fri: 7am - 7pm</span>
                  <span className="text-sm text-muted-foreground">Saturday: 8am - 6pm</span>
                  <span className="text-sm text-muted-foreground">Sunday: 8am - 4pm</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          <p className="text-sm text-muted-foreground">
            {new Date().getFullYear()} TinaBakery. All rights reserved.
          </p>
